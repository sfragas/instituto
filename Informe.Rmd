...
date: "02-12-2021"
=======
title: "Primeira Avaliación IES Muralla Romana. Curso 2021-2022."
#author: "Yolanda Sal Vázquez"
date: "02/12/2021"
>>>>>>> 6bfbfd2529c9e4c1f4a6c11a14d296036be0ae8c
output:
  pdf_document:
    toc: yes
    number_sections: yes
...
=======
Nestes gráficos amósanse para cada clase, trimestre e categorías (resultados académicos) as porcentaxes.
## Resultados para as clases de ESO
...
```{r echo=F,warning=F,message=F}
=======
Nestes gráficos amósanse o número de alumnos por clase e trimestre distribuídos por resultados académicos nun diagrama de barras.
## Móstranse os resultados por trimestre para as clases de ESO
